...
import { fromBase64url, fromHex, randomBytes, toBase64url, toHex } from "../lib/bytes";
import { inviteBundleKey } from "./crypto";
import { KIND } from "./types";
import type { InviteBundle } from "./types";
...
/** Verify a bundle's owner proof: community_id == sha256(...owner, salt). */
